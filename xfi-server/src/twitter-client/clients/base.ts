...
//     twitterLogger.log('Waiting for Twitter login');
//     while (true) {
...
//       twitterLogger.error('Failed to login to Twitter trying again...');
...
//     if (this.profile) {
//       twitterLogger.log('Twitter user ID:', this.profile.id);
//       twitterLogger.log(
//         'Twitter loaded:',
...
//     twitterLogger.debug('fetching home timeline');
...
//       } catch (error) {
//         twitterLogger.error('Error fetching search tweets:', error);
//         return { tweets: [] };
//       }
//     } catch (error) {
//       twitterLogger.error('Error fetching search tweets:', error);
...
//     twitterLogger.debug('populating timeline...');
...
//           twitterLogger.log('Saving Tweet', tweet.id);
...
//           twitterLogger.log('Creating memory for tweet', tweet.id);
...
//       ) {
//         twitterLogger.debug('Message already saved', recentMessage[0].id);
//       } else {
//         await this.runtime.messageManager.createMemory({
//           ...message,
//           embedding: getEmbeddingZeroVector(),
